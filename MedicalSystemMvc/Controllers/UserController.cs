...
namespace MedicalSystemMvc.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(MedicalSystemDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Login(string returnUrl)
        {
            ...
            var userLoginVM = new UserLoginViewModel { ReturnUrl = returnUrl };
        ...
        public ActionResult ConfirmRegistration(UserViewModel userVm)
        {
            return View(userVm);
        }
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public IActionResult CompleteRegistration(UserViewModel userVm)
        {
